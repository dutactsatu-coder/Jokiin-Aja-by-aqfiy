...
import { WHATSAPP_NUMBER, WHATSAPP_URL, INSTAGRAM_URL, WEBSITE_URL } from '../constants';
    ...
    <footer className="bg-slate-900 text-slate-400 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              Partner akademik terbaik untuk mahasiswa dan pelajar di seluruh Indonesia. Kami membantu Anda menyelesaikan laporan, ringkasan, dan presentasi dengan hasil yang memukau. Kunjungi kami di <a href={WEBSITE_URL} className="text-indigo-400 hover:underline">jokiinajabyaqfiy.pelajar.com</a>
            </p>
            <div className="flex space-x-4">
              ...
              <a 
                href="mailto:contact@jokiinajabyaqfiy.pelajar.com" 
        ...
        <div className="pt-8 border-t border-slate-800 text-center text-xs text-slate-500 font-medium">
          <p>© {new Date().getFullYear()} JOKIINAJA BY AQFIY. <a href={WEBSITE_URL} className="hover:text-white transition-colors">jokiinajabyaqfiy.pelajar.com</a>. Seluruh Hak Cipta Dilindungi.</p>
        </div>
      </div>
    </footer>
  );
