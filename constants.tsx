...
// Menggunakan origin browser saat ini agar link tidak mati meskipun domain belum aktif
export const WEBSITE_URL = typeof window !== 'undefined' ? window.location.origin : "#";
